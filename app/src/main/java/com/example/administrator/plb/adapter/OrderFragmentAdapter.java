...
public class OrderFragmentAdapter extends BaseAdapter implements View.OnClickListener{
    private Context context;
    private List<OrderBean> list;

    public OrderFragmentAdapter(Context context, List<OrderBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.fragment_order_adapter, null);
        ...
        viewHolder.mCancelOrder.setOnClickListener(this);
